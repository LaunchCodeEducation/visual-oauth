...
echo "creating client env file at src/api/.env"
echo "you will need to paste in your GITHUB_CLIENT_ID into the REACT_APP_GITHUB_AUTH_ENDPOINT variable in this file"

cat <<- EOF > src/client/.env.test
